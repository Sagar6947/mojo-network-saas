...
const Pricing = () => {
  return (
    <>
      ...
      <section
        id="pricing"
        className="pt-20 pb-20 bg-cover bg-center bg-no-repeat relative"
      >
        <div className="relative max-w-[1600px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {plans.map((plan, index) => (
              ...
              >
                {plan.popular && (
                  <div className="absolute top-0 right-0 bg-orange-500 text-white text-xs px-2 py-1 rounded-bl-lg font-semibold z-10">
                    POPULAR
                  </div>
                )}
